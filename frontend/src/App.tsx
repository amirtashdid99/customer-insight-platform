          ...
          <div className="example-queries">
            ...
            <div className="example-buttons">
              <button 
                ...
                onClick={() => setProductName('iPhone 15')}
                disabled={loading}
              >
                iPhone 15
              </button>
              <button 
                className="example-btn" 
                onClick={() => setProductName('Tesla Model 3')}
                disabled={loading}
              >
                Tesla Model 3
              </button>
              <button 
                className="example-btn" 
                onClick={() => setProductName('Netflix')}
                disabled={loading}
              >
                Netflix
              </button>
              <button 
                className="example-btn" 
                onClick={() => setProductName('PlayStation 5')}
                disabled={loading}
              >
                PlayStation 5
              </button>
              <button 
                className="example-btn" 
                onClick={() => setProductName('MacBook Pro')}
                disabled={loading}
              >
                MacBook Pro
              </button>
